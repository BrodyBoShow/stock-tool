 ...
 *  risk-fit table + spectrum + a stress preview (reused panels). Zone C =
 *  cross-tab chips + the single disclaimer. */
export function RiskFitTab({ riskAlignment, stress, holdings, benchmark, onExplore }: RiskFitTabProps) {
